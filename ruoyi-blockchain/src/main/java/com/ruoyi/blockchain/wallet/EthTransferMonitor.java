...
public class EthTransferMonitor {
    private static EthTransferMonitor instance;
    private Web3j web3j;


    public static EthTransferMonitor getInstance() {
        if (instance == null) {
            synchronized (EthTransferMonitor.class) {
                if (instance == null) {
                    instance = new EthTransferMonitor();
                }
            }
        }
        return instance;
